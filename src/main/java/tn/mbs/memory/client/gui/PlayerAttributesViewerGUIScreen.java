...
public class PlayerAttributesViewerGUIScreen extends AbstractContainerScreen<PlayerAttributesViewerGUIMenu> {
	private final static HashMap<String, Object> guistate = PlayerAttributesViewerGUIMenu.guistate;
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		if (ReturnDisplaySection1Procedure.execute())
			guiGraphics.drawString(this.font,
					...
					ReturnSection1DisplayProcedure.execute(entity), -29, 24, -1, false);
		if (ReturnDisplaySection2Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection2DisplayProcedure.execute(entity), 79, 24, -1, false);
		if (ReturnDisplaySection3Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection3DisplayProcedure.execute(entity), 186, 24, -1, false);
		if (ReturnDisplaySection4Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection4DisplayProcedure.execute(entity), -29, 57, -1, false);
		if (ReturnDisplaySection5Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection5DisplayProcedure.execute(entity), 79, 57, -1, false);
		if (ReturnDisplaySection6Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection6DisplayProcedure.execute(entity), 186, 57, -1, false);
		if (ReturnDisplaySection7Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection7DisplayProcedure.execute(entity), -29, 89, -1, false);
		if (ReturnDisplaySection8Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection8DisplayProcedure.execute(entity), 79, 89, -1, false);
		if (ReturnDisplaySection9Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection9DisplayProcedure.execute(entity), 186, 89, -1, false);
		if (ReturnDisplaySection10Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection10DisplayProcedure.execute(entity), -29, 122, -1, false);
		if (ReturnDisplaySection11Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection11DisplayProcedure.execute(entity), 79, 122, -1, false);
		if (ReturnDisplaySection12Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection12DisplayProcedure.execute(entity), 186, 122, -1, false);
		if (ReturnDisplaySection13Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection13DisplayProcedure.execute(entity), -29, 154, -1, false);
		if (ReturnDisplaySection14Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection14DisplayProcedure.execute(entity), 79, 154, -1, false);
		if (ReturnDisplaySection15Procedure.execute())
			guiGraphics.drawString(this.font,

					ReturnSection15DisplayProcedure.execute(entity), 186, 154, -1, false);
	}
