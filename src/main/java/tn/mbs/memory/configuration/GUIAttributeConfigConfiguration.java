...
public class GUIAttributeConfigConfiguration {
	...
	static {
		...
		DISPLAY_NAME_SECTION_2 = BUILDER.define("display_name", "§fAttack Damage : §6");
		...
		DISPLAY_NAME_SECTION_3 = BUILDER.define("display_name", "§fAttack Speed : §6");
		...
		DISPLAY_NAME_SECTION_5 = BUILDER.define("display_name", "§fMovement Speed : §6");
		...
		DISPLAY_NAME_SECTION_6 = BUILDER.define("display_name", "§fKnock Resistance : §6");
		...
		DISPLAY_NAME_SECTION_7 = BUILDER.define("display_name", "§fArmor Toughness : §6");
