...
public class MainConfigFileConfiguration {
	...
	static {
		BUILDER.push("Attribute_One");
		MAX_HEALTH_LEVEL = BUILDER.define("max_level", (double) 100);
		HEALTH_VALUE_PER_LEVEL = BUILDER.define("value_per_level", (double) 1);
		LOCK_HEALTH = BUILDER.define("lock", false);
		BUILDER.pop();
		BUILDER.push("Attribute_Two");
		MAX_AP_LEVEL = BUILDER.define("max_level", (double) 100);
		AP_VALUE_PER_LEVEL = BUILDER.define("value_per_level", (double) 0.5);
		LOCK_AP = BUILDER.define("lock", false);
		BUILDER.pop();
		BUILDER.push("Attribute_Three");
		MAX_AS_LEVEL = BUILDER.define("max_level", (double) 30);
		AS_VALUE_PER_LEVEL = BUILDER.define("value_per_level", (double) 0.3);
		LOCK_AS = BUILDER.define("lock", false);
		BUILDER.pop();
		BUILDER.push("Attribute_Forth");
		MAX_PROT_LEVEL = BUILDER.define("max_level", (double) 30);
		PROT_VALUE_PER_LEVEL = BUILDER.define("value_per_level", (double) 0.1);
