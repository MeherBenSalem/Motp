...
public class MechanicsConfigConfiguration {
	...
	static {
		...
		BASE_VALUE_PER_POINT_2 = BUILDER.define("base_value_per_point", (double) 0.5);
		...
		MAX_LEVEL_ATT_3 = BUILDER.define("max_level", (double) 30);
		BASE_VALUE_PER_POINT_3 = BUILDER.define("base_value_per_point", (double) 0.3);
		...
		MAX_LEVEL_ATT_4 = BUILDER.define("max_level", (double) 30);
		BASE_VALUE_PER_POINT_4 = BUILDER.define("base_value_per_point", (double) 0.1);
