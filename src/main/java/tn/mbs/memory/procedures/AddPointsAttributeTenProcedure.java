...
public class AddPointsAttributeTenProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		if (entity.getData(MemoryOfThePastModVariables.PLAYER_VARIABLES).SparePoints >= 1 && entity.getData(MemoryOfThePastModVariables.PLAYER_VARIABLES).attribute_10 < (double) MechanicsConfigConfiguration.MAX_LEVEL_ATT_10.get()) {
			...
			{
				MemoryOfThePastModVariables.PlayerVariables _vars = entity.getData(MemoryOfThePastModVariables.PLAYER_VARIABLES);
				_vars.attribute_10 = entity.getData(MemoryOfThePastModVariables.PLAYER_VARIABLES).attribute_10 + (double) MechanicsConfigConfiguration.BASE_VALUE_PER_POINT_10.get();
				_vars.syncPlayerVariables(entity);
			}
			{
				MemoryOfThePastModVariables.PlayerVariables _vars = entity.getData(MemoryOfThePastModVariables.PLAYER_VARIABLES);
