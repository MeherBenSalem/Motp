...
public class ItemUseLockProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		for (String stringiterator : ItemsConfigConfiguration.ITEMS_LIST.get()) {
			if (stringiterator.contains(ForgeRegistries.ITEMS.getKey((entity instanceof LivingEntity _entUseItem1 ? _entUseItem1.getUseItem() : ItemStack.EMPTY).getItem()).toString())) {
